...
router.post('/addnote',fetchuser,body('title').exists(),
// password must be at least 5 chars long
body('desc').exists(),async (req,res)=>{
...
router.put('/updatenote/:id',fetchuser,async (req,res)=>{
    ...
    let upnote=await Notes.findByIdAndUpdate(req.params.id,{$set:newnote},{new:true});
